define(
  [
    'pipAPI',
    'https://cdn.jsdelivr.net/gh/Jacky-Liangjq/zh-TW-ST-IAT-HK-Health-Institution-Trust@eb954a2ec433fe521bde6a722efd9a21bd59fbfd/qstiat6-mobile.js'
  ],
  function (APIConstructor, stiatExtension) {
    ...
    /* =====================================================
       ...
       ===================================================== */
    var instHTML = `
      <div style="font-size:15px; line-height:2.5;">
        <p><b>請在保持準確的情況下，盡量快速地將詞語歸類。</b></p>

        <p>詞語會逐一出現，請根據畫面上方的分類提示作答。</p>

        <p>如按錯，畫面會顯示紅色 <b style="color:red">X</b>，請改按正確的鍵後繼續。</p>

        <p><b>準備好後，請點擊屏幕綠色區域開始。</b></p>
